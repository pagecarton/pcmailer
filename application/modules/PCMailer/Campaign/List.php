    ...
    protected function createList()
    {
		...
		(
			array(
                    ...
                    '<a href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/name/PCMailer_Preview/?campaign_id=%KEY%" target="preview"><i class="fa fa-eye" aria-hidden="true"></i></a>',
